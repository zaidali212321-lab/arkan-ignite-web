...
const items = [
  { icon: Award, title: "الالتزام بالجودة", desc: "تطبيق أعلى معايير الجودة والمواصفات الفنية العالمية في كل مشروع." },
  { icon: ShieldCheck, title: "النزاهة والشفافية", desc: "نلتزم بأعلى مستويات النزاهة والشفافية في جميع تعاملاتنا المهنية." },
  { icon: Sparkles, title: "الابتكار والإبداع", desc: "تقديم حلول مبتكرة ومتطورة باستمرار لتلبية احتياجات عملائنا." },
  { icon: Users, title: "فريق من الخبراء", desc: "نخبة من المهندسين والفنيين المؤهلين بأعلى الشهادات المهنية." },
];

export const WhyUs = () => {
  const ref = useReveal();
  return (
    <section ref={ref as any} dir="rtl" className="relative py-28 bg-dark text-dark-foreground overflow-hidden">
      ...
      <div className="container relative">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="reveal inline-block text-xs font-bold tracking-[0.3em] text-primary-glow uppercase">قيمنا</span>
          <h2 className="reveal reveal-delay-1 font-display text-4xl md:text-5xl mt-4">
            لماذا <span className="text-gradient">تختارنا؟</span>
          </h2>
          <p className="reveal reveal-delay-2 text-dark-foreground/70 mt-4">
            نتميز بمجموعة من القيم والمبادئ التي تجعلنا الخيار الأمثل للشركات الرائدة.
          </p>
        </div>
          ...
          {items.map((it, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-dark-foreground/70 text-sm leading-relaxed">{it.desc}</p>
